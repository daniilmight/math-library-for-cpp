...
В зависимости от настроек точности изменяется время рассчёта. При точности "eps = 1E-9" скорость выполнения становится немного быстрее, чем в math.h.

Результаты бэнчмарка: https://build-bench.com/b/_OA2BGeszy9cQl4aA0aVOk3kC0E
<img width="855" height="427" alt="_OA2BGeszy9cQl4aA0aVOk3kC0E" src="https://github.com/user-attachments/assets/e47e8dc5-20e0-4cf7-b2bd-cc697ae5f88f" />

При этом точность результата сохраняется вплоть до 10 знаков после запятой:

```
-0.279415498204 //dmSin
-0.279415498199 //sin
```
